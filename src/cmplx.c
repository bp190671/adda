...
#endif
//======================================================================================================================
doublecomplex Eye3[3][3]={{1.0+0.0*I,0.0+0.0*I,0.0+0.0*I},{0.0+0.0*I,1.0+0.0*I,0.0+0.0*I},{0.0+0.0*I,0.0+0.0*I,1.0+0.0*I}};
//======================================================================================================================
void imExpTableInit()
 ...
 */
{
	 ...
	 */
#define A1  1.7453292519943295769236907684886127e-2
#define A2 -1.5230870989335429967337177468944678e-4
#define A3 -8.8609615570129801598869213154725066e-7
#define A4  3.8663238515629936539637763508129283e-9
#define A5  1.3496016231632550105929914052816817e-11
#define A6 -3.9258319857430948822261807485761096e-14
